    ...
    <div className="container-fluid min-vh-100 d-flex flex-column flex-md-row p-0">
      ...
      >
        ...
        <p className="fs-5 text-center mt-4" style={{ maxWidth: "400px" }}>
          Empower your business and elevate customer convenience with our mobile-friendly, self-service printing solution.
        </p>
      </div>
      <div className="d-flex justify-content-center align-items-center p-4" style={{ flexBasis: "50%", backgroundColor: "white" }}>
        <form
          className="w-100"
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          ...
          <button className="w-100 btn btn-lg text-white" style={{backgroundColor: "#3799FA"}} type="submit">
            Sign up
          </button>
          <hr className="my-4" />
