...
const CompanyInfo = ({ formData, handleChange }) => {
    return (
        <div className="content">
            ...
            <ButtonGroup>
                <Button
                    variant={formData.companyType === 'Public Library' ? 'primary' : 'outline-primary'}
                    name="companyType"
                ...
                <Button
                    variant={formData.companyType === 'Open Space' ? 'primary' : 'outline-primary'}
                    name="companyType"
                    value="Open Space"
                    onClick={handleChange}
                    className="d-flex align-items-center"
                ...
                <Button
                    variant={formData.companyType === 'Internet Café' ? 'primary' : 'outline-primary'}
                    name="companyType"
                    value="Internet Café"
                    onClick={handleChange}
                    className="d-flex align-items-center"
                ...
                <Button
                    variant={formData.companyType === 'Corporate Office' ? 'primary' : 'outline-primary'}
                    name="companyType"
                ...
                <Button
                    variant={formData.companyType === 'Educational Institution' ? 'primary' : 'outline-primary'}
                    name="companyType"
                ...
                <Button
                    variant={formData.companyType === 'Other' ? 'primary' : 'outline-primary'}
                    name="companyType"
                    value="Other"
                    onClick={handleChange}
                    className="d-flex align-items-center"
            ...
            <ButtonGroup>
                <Button
                    variant={formData.customerType === 'Casual Customers' ? 'info' : 'outline-info'}
                    name="customerType"
                ...
                <Button
                    variant={formData.customerType === 'Business Clients' ? 'info' : 'outline-info'}
                    name="customerType"
                ...
                <Button
                    variant={formData.customerType === 'Tourists' ? 'info' : 'outline-info'}
                    name="customerType"
                    value="Tourists"
                    onClick={handleChange}
                    className="d-flex align-items-center"
                ...
                <Button
                    variant={formData.customerType === 'Students' ? 'info' : 'outline-info'}
                    name="customerType"
                    value="Students"
                    onClick={handleChange}
                    className="d-flex align-items-center"
                ...
                <Button
                    variant={formData.customerType === 'Local Community' ? 'info' : 'outline-info'}
                    name="customerType"
