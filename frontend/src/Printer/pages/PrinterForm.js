        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3 form-group row">
                    <label htmlFor="name" className="col-sm-2 col-form-label">Printer Name</label>
                ...
                <button type="button" className="btn btn-danger ms-3" onClick={handleDelete}>Delete Printer</button>
            </form>
